...
//----end of 取得排除列表 student_sn (98.12.20)
	...
	$query="select distinct b.ss_id from $score_semester a,score_ss b where b.class_year='$c_year' and  a.test_sort='$stage' and a.ss_id=b.ss_id and a.student_sn in ($all_sn) and b.enable='1' and b.scope_id = 82 order by b.sort,b.sub_sort";
	//echo $query."<br>";
