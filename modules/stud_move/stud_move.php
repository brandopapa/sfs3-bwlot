...
switch($key) {
	case $postInBtn :
		...
		if($rs->recordcount()) $confirm_in="<tr><td align='right' colspan='2' bgcolor='#FF8888'><input type='checkbox' name='post_confirm' value='ON'>這個身分證字號( $stud_person_id )曾經有學籍記錄，我確定要執行轉入!!</td></tr>";
