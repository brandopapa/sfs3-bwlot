{{* $Id: stud_move_stud_move_gradu.tpl 5310 2009-01-10 07:57:56Z hami $ *}}
    ...
    <form name ="base_form" action="{{$smarty.server.PHP_SELF}}" method="post" >
		<table border="1" cellspacing="0" cellpadding="2" bordercolorlight="#333354" bordercolordark="#FFFFFF"  width="100%" class=main_body >
	    	...
	    	<input type="hidden" name="update_id" value="{{$smarty.session.session_log_id}}">
				<input type=submit name="do_key" value =" 確定轉出 " onClick="return confirm('確定轉出 '+document.base_form.year_id.value+' 學年畢業生記錄 ?')" >    </td>
			</tr>
		</table><br></td>
	</tr>
	<TR>
