...
include_once "create_doc_function.php";
/* 上傳檔案暫存目錄 */
$path_str = "temp/docword/";
...
/* 程式項目 */
$prob = array("doc1_list.php"=>"收文區","doc_out_list.php"=>"發文區","doc_unit.php"=>"*單位管理","doc_list_print.php"=>"*銷毀清冊列印","doc1_upload.php"=>"收文批次匯入區");
