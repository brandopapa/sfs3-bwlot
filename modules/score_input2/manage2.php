...
if ($is_print!=1) {
	...
	echo "	<html><head><meta content='text/html; charset=big5' http-equiv='Content-Type'><title>成績單</title></head>
		...
		<td align='center' height='19' style='border-width: 1.5pt 1px 0.75pt medium; border-top: 0.75pt solid windowtext; border-right: 1px solid windowtext; border-bottom: 0.75pt solid windowtext; padding: 0cm 1.4pt;' width='50'><font size='2'>平常</font><p><font size='2'>考查</font></td>
