...
<table width="800" cellspacing="1">
	<tr bgcolor="#DDFF95">
		...
		<a href="postnews.php?act=mod&rdsno=<? echo $whichnews; ?>">修改本新聞</a>
		</td>
		<td width="150" align="center">
		<a href="postnews.php?act=del&rdsno=<? echo $whichnews; ?>">刪除本新聞</a>
		</td>
	</tr>
</table>
<table width="800" cellspacing="0">
	...
	<tr>
		...
		<td bgcolor="#FFF8A8">
			...
			<DIV align="right"><? echo $user_name."報導--".substr($postdate,0,10);	?></DIV>
		</td>
		<td width="10" bgcolor="#ACF12C">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="10" bgcolor="#ACF12C">&nbsp;</td>
		<td  bgcolor="#FFF8A8">
			<? echo "相關網址：<a  target='_blank' href='".$newslink."'>".$newslink."</a>"; ?>
		</td>
		<td width="10" bgcolor="#ACF12C">&nbsp;</td>
	</tr>
	<tr bgcolor="#ACF12C">
