...
<form name="myform" method="post" action="{{$smarty.server.PHP_SELF}}">
	<tr class="small">
		...
		{{if $student_sn}}
			<p align="center">
			<font size="3">{{$sch_cname}}{{$sel_year}}學年度第{{$sel_seme}}學期平常生活表現檢核表</p>
			...
			<table bgcolor="#9ebcdd" cellspacing="1" cellpadding="4" width="100%" id="signal_2">
				<tr bgcolor="#c4d9ff">
					<td colspan="2" align="center">平常行為表現項目</td><td align="center">表現狀況</td><td align="center">具體建議</td>
				</tr>
			...
			{{/foreach}}
			{{if $itemdata.items}}
				<tr bgcolor="#c4d9ff"><td colspan="4" style="text-align:center;">平常生活表現</td></tr>
