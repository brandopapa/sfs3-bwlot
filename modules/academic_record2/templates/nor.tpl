...
<title></title></head>
<body>
<p style="text-align:center;"><font face="標楷體" size="3"><{$school_name}> <{$sel_year}> 學年度第 <{$sel_seme}> 學期 <{$class_name}> 平常表現成績 (加減分部份)</font></p>
...
<tr>
	...
	<td style="border-style: solid; border-color: windowtext; border-width: 1.5pt 0.75pt 0.75pt; padding: 0cm 1.4pt;" align="center" width="60">平常考查成績</td>
...
<p style="text-align:center;"><font face="標楷體" size="3"><{$school_name}> <{$sel_year}> 學年度第 <{$sel_seme}> 學期 <{$class_name}> 平常表現成績 (文字描述部份)</font></p>
