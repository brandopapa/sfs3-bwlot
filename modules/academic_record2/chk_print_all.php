...
if($_POST['act']=='列印'){
	...
	if($stud_count){
		...
		foreach($selected_stud as $counter=>$sn_value) {			
			...
			//開始產生HTML資料
			$chk_data.="<p align='center'><font size=5>$school_long_name<BR>$sel_year 學年度第 $sel_seme 學期平常生活表現檢核表</font></p>";
			...
			$chk_data.="<table  STYLE='font-size: ".$item_px."px' border=2 cellpadding='3' cellspacing='0' style='border-collapse: collapse' bordercolorlight='#000000' bordercolordark='#000000' width='100%'>
						<tr bgcolor='#FFCCCC'><td colspan='2' align='center'>平常生活檢核項目</td><td align='center'>表現狀況</td><td align='center'>備註</td></tr>";
			...
			$chk_data.="<table border=2 cellpadding='3' cellspacing='0' style='border-collapse: collapse' bordercolorlight='#000000' bordercolordark='#000000' width='100%'>
						...
						<td align='center' bgcolor='#c4d9ff' width=80>平常生活</td><td>$nor_memo[0]</td></tr>
...
$stud_select="SELECT a.student_sn,a.seme_num,b.stud_name,b.stud_sex FROM stud_seme a,stud_base b WHERE seme_year_seme='$curr_year_seme' and a.seme_class='$class_num' and a.student_sn=b.student_sn and b.stud_study_cond = 0 ORDER BY seme_num";
