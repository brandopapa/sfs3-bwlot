...
echo "
		...
		<tr><td style='line-height: 150%;'>
				<ol>
				<li>檢核表是依據教育部95年5月10日0950064510號函辦理，平常生活評量不作等第轉化，不打成績，只用文字描述。</li>
...
echo "
		...
		<tr><td style='line-height: 150%;'>
				<ol>
				<li>檢核表中「平常行為表現」項目可由各校依需要自行訂定，每學期需由學務（訓導）處做好項目設定，老師方能填寫。</li>
				</ol>
				</td></tr>
				<tr><td></td></tr>
		</table>";        
echo "
		...
		<tr><td style='line-height: 150%;'>
				<ol>
				<li>因為在「學生電子學籍交換標準3.0版」中，並沒有對「表現狀況」欄留欄位，且檢核表可由學校自訂。所以在減低學校老師負擔的前提下，建議<font color=red>列印時採用簡式檢核表</font>，填寫時即可將表現狀況忽略不勾選，具體建議欄則可�秣u填寫（至少填一欄）。</li>
				<li>「具體建議欄」填寫時請根據學生平常表現狀況，依據檢核項目，酌予提供具體建議不作綜合性評價（請勿再給予四字或八字的簡略評語）。</li>
