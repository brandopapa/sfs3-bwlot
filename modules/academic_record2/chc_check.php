...
function get_stsn($class_id){
	...
	$SQL="select a.stud_id,a.stud_name,a.stud_sex,a.student_sn,b.seme_num  from stud_base a,stud_seme b where  a.stud_study_cond = 0 and b.seme_year_seme ='$seme' and b.seme_class='$the_class' and a.student_sn=b.student_sn order by seme_num ";
