...
$chk_menu_arr=($class_num < (curr_year()-93+$IS_JHORES)*100)?array("chk_new.php"=>"填寫平常生活表現評量","chk_print_all.php"=>"列印詳式檢核表"):array();
...
$chk_menu_arr,
array(
"chart_j_new.php"=>"觀看成績單",
"absent.php"=>"觀看勤惰記錄",
"reward.php"=>"觀看獎懲記錄",
//"nor.php"=>"填寫平常成績",
//"score_nor.php"=>"觀看平常總成績"
)
,
array(
"../score_input2/"=>"成績管理 ^",
...
"g_id"=>3,
"var"=>"平常行為表現",
"s_arr"=>array(1=>"值得讚賞",2=>"表現良好",3=>"表現尚可",4=>"需再加油",5=>"有待改進")
);
