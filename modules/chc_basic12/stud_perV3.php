...
/* 取學生陣列,取自stud_base表與stud_seme表*/
	function get_stu($Sn){
		...
		c.student_sn='{$Sn}' and c.student_sn=a.student_sn and c.student_sn=b.student_sn 
		 order by b.seme_year_seme desc limit 1 ";//and left(b.seme_year_seme,3)='{$this->Year}' 
		//-- 102.10.29 加入可以讓1-2年級查詢的語法
		$SQL="select a.stud_id,a.stud_name,a.stud_birthday ,a.stud_sex, a.stud_person_id ,a.curr_class_num,
		b.seme_class,b.seme_num,a.stud_study_cond , c.*  
		from stud_base a, stud_seme b LEFT JOIN chc_basic12 c ON ( b.student_sn=c.student_sn  )  
		where a.student_sn='{$Sn}' and a.student_sn=b.student_sn  order by b.seme_year_seme desc limit 1 ";
		//-- 102.10.29 
		...
		from stud_base a, stud_seme b  where  a.student_sn='{$Sn}' and b.student_sn=a.student_sn  
		order by b.seme_year_seme asc ";
