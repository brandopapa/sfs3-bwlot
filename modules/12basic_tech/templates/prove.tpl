...
<div align="center">
	<table  border='2' cellpadding='3' cellspacing='0' style='border-collapse: collapse;' bordercolor='#111111' id='AutoNumber1' width='100%'>
		...
		<tr>
			...
			<td width="65%" align="left" height="43">{{foreach from=$competetion_score.$i.detail item=data key=k}}<li>({{$level_array[$data.level]}}-{{$squad_array[$data.squad]}}){{$data.name}}：{{$data.rank}}</li>{{/foreach}}</td>
