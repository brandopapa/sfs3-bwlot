...
if($_POST['act']){
	...
	switch($_POST['act']){
		case 'EXCEL':
			...
			$x->items[0]=array('身分證統一編號','學生姓名','出生年(民國年)','出生月','出生日','年級','班級','座號','報名資格','郵遞區號','地址','市內電話','行動電話','特種生加分類別','報名費減免身分','競賽','擔任幹部','服務時數','服務學習','累計嘉獎','累計小功 ','累計大功 ','累計警告','累計小過','累計大過','日常生活表現評量','肌耐力','柔軟度','瞬發力','心肺耐力','體適能','多元學習表現','技藝教育成績','技藝優良','弱勢身分','弱勢積分','健康與體育','藝術與人文','綜合活動','均衡學習','家長意見','導師意見','輔導教師意見','適性輔導','其他比序項目(全民英檢)','合計','報名「北區」五專學校代碼','報名「中區」五專 學校代碼','報名「南區」五專學校代碼','競賽名稱','其他比序項目(多益測驗)'); 
			break;
		case 'HTML':
			$main="<table border='2' cellpadding='3' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' id='AutoNumber1' width='200%'>
				<tr bgcolor='#ffcccc' align='center'><td>身分證統一編號</td><td>學生姓名</td><td>出生年(民國年)</td><td>出生月</td><td>出生日</td><td>年級</td><td>班級</td><td>座號</td><td>報名資格</td><td>郵遞區號</td><td>地址</td><td>市內電話</td><td>行動電話</td><td>特種生加分類別</td><td>報名費減免身分</td><td>競賽</td><td>擔任幹部</td><td>服務時數</td><td>服務學習</td><td>累計嘉獎</td><td>累計小功 </td><td>累計大功 </td><td>累計警告</td><td>累計小過</td><td>累計大過</td><td>日常生活表現評量</td><td>肌耐力</td><td>柔軟度</td><td>瞬發力</td><td>心肺耐力</td><td>體適能</td><td>多元學習表現</td><td>技藝教育成績</td><td>技藝優良</td><td>弱勢身分</td><td>弱勢積分</td><td>健康與體育</td><td>藝術與人文</td><td>綜合活動</td><td>均衡學習</td><td>家長意見</td><td>導師意見</td><td>輔導教師意見</td><td>適性輔導</td><td>其他比序項目(全民英檢)</td><td>合計</td><td>報名「北區」五專學校代碼</td><td>報名「中區」五專 學校代碼</td><td>報名「南區」五專學校代碼</td><td>競賽名稱</td><td>其他比序項目(多益測驗)</td>";
			break;
	}
