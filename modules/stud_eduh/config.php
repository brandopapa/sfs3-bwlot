...
$menu_p = array("stud_eduh_personal.php"=>"個人輔導記錄列表",
...
"index2.php"=>"輔導記錄表","index2_html.php"=>"網頁式輔導記錄表","index2_add.php"=>"輔導訪談記錄貼條 ","stud_eduh_report.php"=>"家庭狀況統計","stud_psy_test_list.php"=>"心理測驗記錄貼條");
