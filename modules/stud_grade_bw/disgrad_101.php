...
if($abs_base_days){
	...
	$query="select a.student_sn,b.curr_class_num,b.stud_name,b.stud_study_year,b.stud_id from grad_stud a inner join stud_base b on a.student_sn=b.student_sn where stud_grad_year='$stud_grad_year' order by b.curr_class_num";
	$res=$CONN->Execute($query);
	while(!$res->EOF) {
