...
if($stud_class)
{
	...
	$studentdata="<tr align='center' bgcolor='#ff8888'><td width=80>學號</td><td width=50>座號</td><td width=120>姓名</td><td width=$pic_width>大頭照</td><td>低收/中低收 入戶</td><td>級分統計</td><td>備註</td>";
