...
//echo "</pre>";
	...
	$studentdata="<tr align='center' bgcolor='#ff8888'><td width=80>學號</td><td width=50>座號</td><td width=120>姓名</td><td width=$pic_width>大頭照</td><td>國文</td><td>數學</td><td>英語</td><td>社會</td><td>自然</td><td>級分統計</td><td>備註</td>";
	while(!$recordSet->EOF){
