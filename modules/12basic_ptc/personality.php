...
//echo "</pre>";	
	...
	$studentdata="<tr align='center' bgcolor='#ff8888'><td width=80>學號</td><td width=50>座號</td><td width=120>姓名</td><td width=$pic_width>大頭照</td><td>我的志願</td><td>家長建議</td><td>輔導小組建議</td><td>級分統計</td><td>備註</td>";
	while(!$recordSet->EOF){
