...
<TR bgcolor=#9EBCDD>
 ...
 {{if $IS_JHORES==6}}
 	<table border="0">
 		<tr>
 			<td>。<font color="#0000FF"><INPUT TYPE='checkbox' name='stud_chk_data' value='checked' {{if $M_SETUP.stud_chk_data==1}}checked{{/if}}>平常生活表現(<INPUT TYPE='checkbox' name='stud_chk_data_detail' value='checked' {{if $M_SETUP.stud_chk_data_detail==1}}checked{{/if}}>含檢核表)</font></td>
 		</tr>
 		<tr>
