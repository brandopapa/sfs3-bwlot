...
<title>{{if $smarty.post.years!=6}}五學期{{else}}畢業{{/if}}平常表現成績表</title>
</head>

<body>
<table border="0" cellspacing="0" cellpadding="0" width="610">
<tr align="right">
<td colspan="{{$ss_num+4}}"><b>{{$class_base[$seme_class]}} {{if $smarty.post.years!=6}}五學期{{else}}畢業{{/if}}平常表現成績表　　　　　 <font size="1" style="font-size: 10pt">列印日期：{{$smarty.now|date_format}}</font></b></td>
</tr>
<tr align="center">
