...
<input type="checkbox" checked>平常生活表現成績未達「各學期均在60分以上」<font color="red">(必選)</font><br>
{{if $smarty.post.years==6}}<input type="checkbox" name="chk_last"{{if $smarty.post.chk_last}}checked{{/if}} OnChange="this.form.submit();">且第六學期平常生活表現成績亦未達60分{{/if}}</td>
</tr>
