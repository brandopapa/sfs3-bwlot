...
$stud_chk_data=$_POST['stud_chk_data']; 				//是否列印平常生活表現
$stud_chk_data_detail=$_POST['stud_chk_data_detail']; 				//是否列印平常生活檢核表
...
if($_POST){
  ...
  $smarty->assign("stud_chk_data",$stud_chk_data);  		// 是否列印平常生活檢核
