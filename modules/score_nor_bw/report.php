...
if ($_POST [act] == 'OK') {
	...
	// 簽章檔
	// 校長
	// 20170119 Update by Brando. hidden signature
	/*
	...
	foreach ( $sn_ary as $student_sn ) {
		...
		$smarty->assign ( 'title_arr', $student_data->title_arr );
