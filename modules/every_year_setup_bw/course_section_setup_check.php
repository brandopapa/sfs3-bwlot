...
function &class_form($sel_year,$sel_seme){
	...
	$help_text="
	請選擇一個學年學期以做檢查。||
	<span class='like_button'>開始檢查</span> 會開始進行全校的排課檢查。
	";
	$help=&help($help_text);
	...
	<tr bgcolor='#FFFFFF'><td>
		...
		<tr><td colspan='2'><input type='submit' value='開始檢查'>
		</td></tr>
		</form>
		</table>
	</td></tr>
...
function &ss_class_num($sel_year,$sel_seme){
	...
	foreach($c_year_array as $yc){
		...
		for($i=0;$i < sizeof($class_id_array[$Cyear]) ;$i++){
			...
			$class_name=$cy_name."".$class_data[c_name]."班";			
    ...
    $tr2.="</tr>";
		...
		//$td.="</table>";
		$n = $n + 1 ;		
		//$tr2.="<tr bgcolor='#FFFFFF'><td align='center' rowspan=$n><b>$cy_name</b><p>共 <font color='#008000'>$n</font> 門課<p>已排 <font color='#FF0000'>$all</font> 節</td></tr>$td";
		$tr2.="<tr bgcolor='#FFFFFF'><td align='center' rowspan=$n><b>$cy_name</b><p>共 <font color='#008000'>$n</font> 門課</td></tr>$td";
	}
