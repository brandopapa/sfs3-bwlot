...
<tr>
	...
	<td>
	  ...
	  <input type=radio name=book_bind  <?php if($book_bind=="精裝"){echo "checked";} ?> value="精裝">精裝
	   &nbsp;<input type=radio name=book_bind  <?php if($book_bind=="平裝"){echo "checked";} ?> checked value="平裝">平裝
	</td>
</tr>
