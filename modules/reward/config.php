...
// $Id: config.php 7207 2013-03-10 14:33:59Z smallduh $
	...
	//目錄內程式
	$student_menu_p = array("reward_one.php"=>"在籍生個人獎懲登記","reward_entrance.php"=>"轉學生個人獎懲補登","reward_group.php"=>"團體獎懲登記","reward_eli_new.php"=>"銷過","reward_stud_all.php"=>"個人獎懲明細","add_record.php"=>"學期獎懲補登","add_record_person.php"=>"個人學期獎懲補登","reward_list.php"=>"懲戒列表","reward_total.php"=>"學生獎懲統計","report.php"=>"列印獎懲公告","reward_exchange.php"=>"轉學生期中獎懲匯入記錄");
