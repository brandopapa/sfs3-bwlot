...
//		$temp[]=get_score_array($sel_year,$sel_seme,$stud_id,$student_sn,$class_id);    
    ...
    $score_array["生活主軸_學期總平均加權"]=
    $score_array["生活教育-生活技能-農耕加權"]+
    $score_array["生活教育-群己活動-社團加權"]+
    $score_array["生活教育-理念學習加權"]+
    $score_array["生活教育-生活規範加權"]+
    $score_array["生活教育-健康生活加權"]+
    $score_array["生活教育-服務學習加權"];
    
    $score_array["生活主軸_學期總分數"]= 
    $score_array["生活教育-生活技能-農耕分數"]*$score_array["生活教育-生活技能-農耕加權"]+
    $score_array["生活教育-群己活動-社團分數"]*$score_array["生活教育-群己活動-社團加權"]+
    $score_array["生活教育-理念學習分數"]*$score_array["生活教育-理念學習加權"]+
    $score_array["生活教育-生活規範分數"]*$score_array["生活教育-生活規範加權"]+
    $score_array["生活教育-健康生活分數"]*$score_array["生活教育-健康生活加權"]+
    $score_array["生活教育-服務學習分數"]*$score_array["生活教育-服務學習加權"];
    ...
    $score_array["生命主軸_學期總平均加權"]=$score_array["生命教育-孝經加權"]+$score_array["彈性課程-生命教育加權"];    
    $score_array["生命主軸_學期總分數"]=$score_array["生活教育-孝經分數"]*$score_array["生活教育-孝經加權"]+$score_array["彈性課程-生命教育分數"]*$score_array["彈性課程-生命教育加權"]; 
    ...
    $score_array["基礎主軸_學期總平均加權"]=$score_array["生命教育-基礎課程加權"]+$score_array["彈性課程-經典背誦加權"]+$score_array["藝術與人文-表演藝術加權"];
    $score_array["基礎主軸_學期總分數"]=$score_array["生命教育-基礎課程分數"]*$score_array["生命教育-基礎課程加權"]+$score_array["彈性課程-經典背誦分數"]*$score_array["彈性課程-經典背誦加權"]+$score_array["藝術與人文-表演藝術分數"]*$score_array["藝術與人文-表演藝術加權"];
