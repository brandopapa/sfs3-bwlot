...
//		$temp[]=get_score_array($sel_year,$sel_seme,$stud_id,$student_sn,$class_id);    
    ...
    $score_array["生活主軸-生活技能-農耕加權"]+
    $score_array["生活主軸-群己活動-社團加權"]+
    $score_array["生活主軸-理念學習加權"]+
    $score_array["生活主軸-生活規範加權"]+
    $score_array["生活主軸-健康生活加權"]+
    $score_array["生活主軸-服務學習加權"];
    
    $score_array["生活主軸_學期總分數"]= 
    $score_array["生活主軸-生活技能-農耕分數"]*$score_array["生活主軸-生活技能-農耕加權"]+
    $score_array["生活主軸-群己活動-社團分數"]*$score_array["生活主軸-群己活動-社團加權"]+
    $score_array["生活主軸-理念學習分數"]*$score_array["生活主軸-理念學習加權"]+
    $score_array["生活主軸-生活規範分數"]*$score_array["生活主軸-生活規範加權"]+
