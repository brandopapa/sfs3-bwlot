...
<span class="small"><input type="checkbox" name="include_nor">含平常成績 <input type="checkbox" name="include_avg" checked>含平均  <input type="checkbox" name="include_no">含證明字列  起始號：<input type="text" name="start_no" size=3 value=""></span> <br>
