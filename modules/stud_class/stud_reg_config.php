<?php
	...
	//目錄內程式
	$menu_p = array("stud_list.php"=>"基本資料","chi_edit2.php"=>"速編","stud_dom1.php"=>"戶口資料","stud_ext_data.php"=>"補充資料","stud_bs.php"=>"兄弟姐妹","stud_kinfolk.php"=>"其他親屬","basisdata_check.php"=>"基本資料檢查","$eduh_input_method"=>"學期輔導","stud_seme_talk2.php"=>"輔導訪談","stud_seme_spe2.php"=>"特殊表現","stud_psy_test.php"=>"心測記錄","stud_report1.php"=>"學籍記錄表","index2_html.php"=>"輔導記錄表","chc_940531.php"=>"歷屆成績");
