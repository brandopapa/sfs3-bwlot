...
if($act=="dl_oo"){
	...
	if($class_num){
		...
		if($test_sort)	$download="<td><font style='border: 2px outset #EAF6FF'><a href='{$_SERVER['PHP_SELF']}?act=dl_oo&test_sort=$test_sort&class_num=$class_num'>下載sxw</a></font><font style='border: 2px outset #EAF6FF'><a href='{$_SERVER['PHP_SELF']}?act=dl_pdf&test_sort=$test_sort&class_num=$class_num'>下載PDF</a></font></td>";
