...
function &main_form($sel_year,$sel_seme,$stud_arr){
	...
	<td colspan=6>
	學號<input type=text size=6 maxlength=6 name=all_stud[0] value=".$stud_arr[0]."> 學號<input type=text size=6 maxlength=6 name=all_stud[1] value=".$stud_arr[1]."> 學號<input type=text size=6 maxlength=6 name=all_stud[2] value=".$stud_arr[2]."><br>
	學號<input type=text size=6 maxlength=6 name=all_stud[3] value=".$stud_arr[3]."> 學號<input type=text size=6 maxlength=6 name=all_stud[4] value=".$stud_arr[4]."> 學號<input type=text size=6 maxlength=6 name=all_stud[5] value=".$stud_arr[5]."><br>
	學號<input type=text size=6 maxlength=6 name=all_stud[6] value=".$stud_arr[6]."> 學號<input type=text size=6 maxlength=6 name=all_stud[7] value=".$stud_arr[7]."> 學號<input type=text size=6 maxlength=6 name=all_stud[8] value=".$stud_arr[8]."><br>
