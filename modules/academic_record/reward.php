...
if ($view=="One") {
	...
	$main.="</table><br><a href={$_SERVER['PHP_SELF']}?view=All>觀看全班記錄</a>";
} else {
	//顯示表頭資料
	?>
	<table border="0" width="100%">
	  <tr>
	   <td style="font-size:9pt;color=#FF0000"><input type="button" style="bgcolor:#FFCCCC;font-size:9pt" value="即時更新" onclick="window.location='reward.php?recal=1'">※說明:發現本表統計資料有誤, 請按此鈕進行資料重新統計。</td>
	  </tr>
	</table>
	<?php
	//顯示表頭資料
