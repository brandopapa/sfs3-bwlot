...
function &list_ss($sel_year,$sel_seme,$Cyear="",$class_id="",$mode="",$id=0,$add_scope_id=0,$subject_id=0,$act=""){
	...
	<tr bgcolor='#E1ECFF'>
		...
		<td align='center' nowrap>分科</td>
		<td align='center' nowrap>課程代碼</td>
		<td align='center' nowrap>節數</td>		
		<td align='center' nowrap>計分</td>
		<td align='center' nowrap>完整</td>		
		<td align='center' nowrap>加權</td>
		<td align='center' nowrap>排序</td>
		<td align='center' nowrap>九年一貫對應</td>
		<td align='center' nowrap>平時成績項目指定</td>
		$modify_tool_title
