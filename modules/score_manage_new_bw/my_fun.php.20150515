...
function score_period_menu($id,$other_script="") {
	$show_score_period[100]='100分(不含)以下90分以上';
	$show_score_period[90]='90分(不含)以下80分以上';
	$show_score_period[80]='80分(不含)以下70分以上';
	$show_score_period[70]='70分(不含)以下60分以上';
