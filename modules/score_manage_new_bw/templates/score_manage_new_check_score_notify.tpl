...
<tr>
<td>
{{$year_seme_menu}} {{$class_year_menu}} {{$section1}} {{$section2}} {{$section3}} {{$score_period_menu}}
...
<tr bgcolor="#ffffff">
<td>班級<td>座號<td>姓名<td>科目<td>段次<td>成績種類<td>成績</td>
</tr>

{{foreach from=$score_data_key item=d1}}
  {{foreach from=$score_data[$d1] item=d}}
