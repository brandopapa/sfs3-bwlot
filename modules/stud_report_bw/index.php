...
//echo "<textarea rows=50 cols=80>".$data_arr[$stud_id]["photo"]."</textarea>";
    ...
    $sql="select stud_id,guardian_name,guardian_relation from stud_domicile where student_sn in ($student_sn_list)";
		...
		while(!$res->EOF) {
			...
			$stud_semester='grade_'.$grade.'_'.$semester;
			$data_arr[$stud_id][$stud_semester]=($year+0).'學年度第'.$semester.'學期';;
...
//		$temp_arr["grandmoth_alive"] = $is_live_arr[$grandmoth_alive];
		...
		while(!$res->EOF){
			...
			$temp_stud_move .= '<table:table-row><table:table-cell table:style-name="摮貊??啣?蝝??.A2" table:value-type="string"><text:p text:style-name="P12">'.$move_kind.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.B2" table:value-type="string"><text:p text:style-name="P12">'.$move_date.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.B2" table:value-type="string"><text:p text:style-name="P12">'.$move_year_seme.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.B2" table:value-type="string"><text:p text:style-name="P12">'.$school_id.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.B2" table:value-type="string"><text:p text:style-name="P12">'.$school.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.B2" table:value-type="string"><text:p text:style-name="P12">'.$move_c_unit.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊??啣?蝝??.G2" table:value-type="string"><text:p text:style-name="P12">'.$move_c_num.'</text:p></table:table-cell></table:table-row>';
			$res->MoveNext();
		}
...
//			$semester = $res->fields[semester];
			...
			$seme_name = Num2CNum($this_year).$seme_name;
                        $seme_name = $ttt->change_str($seme_name);	
			$temp_stud_score.='<table:table-row><table:table-cell table:style-name="摮貊????閰??蝝??銵?A2" table:value-type="string"><text:p text:style-name="P13">'.$year_seme.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊????閰??蝝??銵?B2" table:value-type="string"><text:p text:style-name="P13">'.$seme_name .'</text:p></table:table-cell><table:table-cell table:style-name="摮貊????閰??蝝??銵?B2" table:value-type="string"><text:p text:style-name="P13">'.$ss_name.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊????閰??蝝??銵?B2" table:value-type="string"><text:p text:style-name="P13">'.$ss_score.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊????閰??蝝??銵?B2" table:value-type="string"><text:p text:style-name="P13">'.$ss_rule.'</text:p></table:table-cell><table:table-cell table:style-name="摮貊????閰??蝝??銵?F2" table:value-type="string"><text:p text:style-name="P18">'.$ss_score_memo.'</text:p></table:table-cell></table:table-row>';
			$res->MoveNext();
		}
