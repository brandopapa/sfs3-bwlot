...
function download_csv($year){
  global $CONN,$school_sshort_name,$school_long_name;
   ...
   $sql_select="select stud_id,stud_name,stud_sex,stud_person_id,stud_birthday,stud_addr_1 from stud_base where stud_study_year ='".$year."' and (stud_study_cond='0' and stud_study_cond='8') ";
