...
// $Id: sfs_case_dataarray.php 7234 2013-03-16 13:16:21Z infodaes $
// 各種資料陣列
...
function stud_abs_kind(){
	//return array("1"=>"事假","2"=>"病假","7"=>"喪假" ,"3"=>"曠課","4"=>"集會","5"=>"公假","6"=>"其他");
	return array("1"=>"事假","2"=>"病假","3"=>"曠課","4"=>"集會","5"=>"公假","6"=>"其他");
}

//教師假別 〈2004-9-29 by brucelyc   2011-2-14 extend by infodaes〉
function tea_abs_kind(){
	return array("11"=>"事假","12"=>"家庭照顧假","21"=>"病假","22"=>"生理假","31"=>"公差","41"=>"婚假","42"=>"產前假","43"=>"娩假","44"=>"流產假","45"=>"陪產假","46"=>"喪假","47"=>"公假","52"=>"公差假","61"=>"其他","23"=>"延長病假","81"=>"休假","82"=>"補休假","91"=>"骨髓捐贈假","92"=>"器官捐贈假","93"=>"災防假");
}
...
//平常生活表現文字項目
function nor_text(){
	return array(0=>"平常行為",1=>"團體活動",2=>"公共服務_校內",3=>"公共服務_校外",4=>"特殊表現_校內",5=>"特殊表現_校外");
}
