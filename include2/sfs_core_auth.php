<?php
// $Id: sfs_core_auth.php 7556 2013-09-20 13:39:13Z hami $
...
class CDC
{
        ...
        function readCert() {
                ...
                if ($this->cert && $this->cer_sn) {
                        ...
                        //查詢憑證狀態
                        $output = shell_exec('openssl ocsp -issuer '.dirname(__FILE__).'/../MOICA.crt -cert /tmp/'.$this->cer_sn.'.crt -url http://moica.nat.gov.tw/cgi-bin/OCSP/ocsp_server.exe');
                        $output2 = preg_split('/[\r\n]/', $output);
