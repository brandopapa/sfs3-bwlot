...
***********************************/
//程式根目錄 PATH
$SFS_PATH = "/home/sfs6/dev3.sfs3.bwsh.kindn.es";

//學務管理首頁程式 URL (設定時，保留最後的 "/" )
$SFS_PATH_HTML ="http://dev3.sfs3.bwsh.kindn.es/"; 

//學校首頁 URL
$HOME_URL ="http://dev3.sfs3.bwsh.kindn.es/";
...
$UPLOAD_PATH = "/home/sfs6/dev3.sfs3.bwsh.kindn.es/data/";
...
//------------底下設定勿改
require "$SFS_PATH/include2/sfs_API.php"; //系統核心函式庫
//重新認證檔案url
...
require_once("$SFS_PATH/include2/sfs_case_ado.php"); # 函式庫
