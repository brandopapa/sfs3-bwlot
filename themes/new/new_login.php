	...
	";
	 ...
	 <br>
	  <div style=\"border-width:1px; border-color:black;  padding:3px; font-size:15px;\">
	   ...
	   <table border='0'>
	   <tr>
	   <td style='color:#0000FF'>§本站允許使用臺中市教育局帳號登入</td>
	   </tr>
	   <tr>
	   <td>
...
function login_form3(){
	...
	<input type='hidden' name='go_back' value='$go_back'>
	<span class='small'> &nbsp; &nbsp; 要使用自然人憑證登入, 您須先 :<br> &nbsp; 1.  安裝<a href='http://gca.nat.gov.tw/download/HiCOSClient_v2.1.8.zip' target='new'>HiCOS憑證管理程式</a>及<a href='http://www.sfs.project.edu.tw/modules/mydownloads/visit.php?cid=2&lid=47'>臺中市政府教育局憑證登入元件v0.3版</a><br> &nbsp; 
